                                        ...
                                        <div class="card-body">
                                                  ...
                                                  <table id="add-row" class="display table table-striped table-hover" >
                                                            ...
                                                            foreach($conn ->query($result) as $lista){?>
                                                                      ...
                                                                      <tr>
                                                                                ...
                                                                                <td>
                                                                                          <div class="form-button-action">
                                                                                                    ...
                                                                                                    <button type="button"  class="btn btn-link btn-danger"  data-toggle="modal" data-target="#exampleModal1<?php echo $lista['id_fichas'] ?>">
                                                                      ...
                                                                      <?php  include("../Modal_Fichas/eliminar_fichas.php");?>
