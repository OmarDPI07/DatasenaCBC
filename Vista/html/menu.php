...
<body>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<!-- <img src="../Estilos/" alt="navbar brand" class="navbar-brand"> -->
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/profile2.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="../Estilos/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../Estilos/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									<li>
										<a href="registro_instructor.php">
											<span class="sub-item">Registrar Instructor</span>
										</a>
									</li>
									<li>
										<a href="registro_aprendiz.php">
											<span class="sub-item">Registrar aprendiz</span>
										</a>
									</li>
									<li>
										<a href="registro_programa.php">
											<span class="sub-item">Registrar Programa</span>
										</a>
									</li>
									<li>
										<a href="registro_fichas.php">
											<span class="sub-item">Registrar Fichas</span>
										</a>
									</li>
								</ul>
							</div>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Bienvenido Admin</h2>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Estadisticas de Registro</div>
									<div class="card-category"></div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-1"></div>
											<h6 class="fw-bold mt-3 mb-0">Pasantes Registrados</h6>
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-2"></div>
											<h6 class="fw-bold mt-3 mb-0">Instructores de pasantias</h6>
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-3"></div>
											<h6 class="fw-bold mt-3 mb-0">Programas</h6>
										</div>
									</div>
								</div>
							</div>
	...
	<!-- jQuery Sparkline -->
	<script src="../Estilos/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="../Estilos/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script src="../Estilos/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>
	...
	<script src="../Estilos/js/setting-demo.js"></script>
	<script src="../Estilos/js/demo.js"></script>
...
?>
    ...
    $sql2="SELECT COUNT(programas.id_programa) as canti FROM programas";
		?>
		Circles.create({
			id:'circles-3',
			radius:45,
		...
		var mytotalIncomeChart = new Chart(totalIncomeChart, {
			type: 'bar',
			data: {
				labels: ["ADSI", "GANADERIA", "ESPECIES MENORES", "PRODUCCION AGRICOLA", "ACUICOLA", "COCINA", "S", "S", "M", "T"],
				datasets : [{
					label: "Total Income",
