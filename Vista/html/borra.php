...
<body>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="../Estilos/img/logo.svg" alt="navbar brand" class="navbar-brand">
				</a>
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/jm_denis.jpg" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="../Estilos/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
	...
	<!-- Bootstrap Notify -->
	<script src="../Estilos/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
...
?>
    ...
    $sql1="SELECT COUNT(instructor.id_instructor) as cant FROM instructor";
		...
		Circles.create({
			...
			width:7,
			<?php 
            foreach($con ->query($sql1) as $lista){
            ?>  
    ...
    $sql2="SELECT COUNT(programas.id_programa) as canti FROM programas";
		...
		Circles.create({
			...
			width:7,
			<?php 
            foreach($con ->query($sql2) as $lista){
            ?>  
