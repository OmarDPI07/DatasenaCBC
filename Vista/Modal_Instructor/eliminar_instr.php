...
<div class="modal fade" id="exampleModal1<?php echo $lista['id_instructor'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 style="text-align: center !important"> 
                        <center><?php echo $lista['nombre']; ?>  </center>
                        <hr>
