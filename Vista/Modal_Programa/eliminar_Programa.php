...
<div class="modal fade" id="exampleModal1<?php echo $lista['id_programa'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                style="background: #00B4DB;  /* fallback for old browsers */
                    ...
                    <h4 style="color:white;" class="modal-title">
                        ¿Realmente deseas eliminar este programa?
                        
                    </h4>
                </div>
                <div class="modal-body">
                    <h4 style="text-align: center !important"> 
                        <center><?php echo $lista['nombre_progra']; ?>  </center>
                        <hr>
